...
function Kavo:LoadUIPosition()
    ...
    return UDim2.new(0.336503863, 0, 0.275485456, 0)
end
...
function Kavo:Notify(title, content, duration, image)
    ...
    notifications[LibName][notificationId] = notificationData
    ...
    iconImage.Image = "rbxassetid://"..tostring(image or 3926305904)
    iconImage.ImageColor3 = themeList.SchemeColor or Color3.fromRGB(74, 99, 135)
    ...
    progressBarFill.BackgroundColor3 = themeList.SchemeColor or Color3.fromRGB(74, 99, 135)
...
function Kavo.CreateLib(kavName, themeList)
    ...
    minimize.Position = UDim2.new(0.90, 0, 0.137999997, 0)
